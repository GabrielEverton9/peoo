 ...
 */
public class Classe04 extends javax.swing.JDialog {

    /**
     * Creates new form FormatarFonte
     */
    public Classe04(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    }
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        Classe051 notepad = (Classe051) this.getParent();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Classe04.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                Classe04 dialog = new Classe04(new javax.swing.JFrame(), true);
