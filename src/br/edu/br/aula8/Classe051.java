...
import br.edu.br.aula8.Classe04;
 ...
 */
public class Classe051 extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        barraDeFerramentas.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                barraDeFerramentasActionPerformed(evt);
            }
        });
        jMenu4.add(barraDeFerramentas);

        barraDeStatus.setText("Barra de Status");
        barraDeStatus.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                barraDeStatusActionPerformed(evt);
            }
        });
        ...
        exibirAjuda.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                exibirAjudaActionPerformed(evt);
            }
        });
    ...
    private void formatarFonteActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_formatarFonteActionPerformed
        ...
        Classe04 fonte = new Classe04(this, false);
    ...
    private void barraDeFerramentasActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_barraDeFerramentasActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_barraDeFerramentasActionPerformed
    ...
    private void salvarArquivoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_salvarArquivoActionPerformed
        ...
        try {
            ...
            Logger.getLogger(Classe051.class.getName()).log(Level.SEVERE, null, ex);
        }
    ...
    private void barraDeStatusActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_barraDeStatusActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_barraDeStatusActionPerformed

    private void exibirAjudaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_exibirAjudaActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_exibirAjudaActionPerformed
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Classe051.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
